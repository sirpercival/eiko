    ...
    if answer:
        ...
        if answer:
            ...
            try:
                ...
                return phenny.say('No results. (Please install BeautifulSoup for additional checking.)')
            ...
            if output:
                ...
                phenny.say('Absolutely no results!')
c.commands = ['c', 'calc']
c.example = '.c 5 + 3'
...
def py(phenny, input):
    ...
    code = input.group(2)
    if not code:
        return phenny.reply('No code provided.')
    ...
    try:
        ...
        phenny.reply('The server did not return an answer.')
        print '[.py]', e
...
def wa(phenny, input):
    ...
    try:
        ...
        return phenny.say("Request timd out")
    if answer:
        ...
        phenny.say('Sorry, no result from WolframAlpha.')
